...
namespace DragDropDataBinding
{
    public static class DataLayer
    {
        public static List<Status> GetStatuses()
        {
            ...
            {
                new Status { Id = 1, Name = "Silver" },
                new Status { Id = 2, Name = "Gold" },
                new Status { Id = 3, Name = "Platinum" },
            };
        }
        ...
        public static List<Customer> GetCustomers()
        {
            ...
            {
                new Customer { Id=Guid.Parse("946D4FAE-7446-EE7D-467C-5A2A3F1E3BEE"), FirstName="Assem", LastName="Toumi", Phone="55-331-363", Age=30, IsActive=false, StatusId=1, Status="Silver"},
                new Customer { Id=Guid.Parse("5A7DB000-24D0-96CD-4F8E-D131158F6FF1"), FirstName="Daria", LastName="Rice", Phone="491-588-5415", Age=20, IsActive=true, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("387AF170-1AAA-43DF-24B9-FB074368DA66"), FirstName="Acton", LastName="Keller", Phone="441-273-6974", Age=64, IsActive=true, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("EC6C0E45-4A25-6C9E-D6FF-60F20784B585"), FirstName="Galena", LastName="Collier", Phone="666-795-1219", Age=21, IsActive=true, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("5E04A1B3-CC0D-5EA4-6DBB-FDF432270530"), FirstName="Nissim", LastName="Mercer", Phone="409-355-2361", Age=63, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("A9B4E771-5061-5A98-C49F-5C7C5D6B9B05"), FirstName="Lisandra", LastName="Clayton", Phone="354-359-7133", Age=57, IsActive=true, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("AA799FEB-9836-5630-8B97-63528AAAD23B"), FirstName="Zenia", LastName="Thomas", Phone="849-907-9904", Age=53, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("CDC6F950-F08E-816D-740D-2B5B21112D77"), FirstName="Nerea", LastName="Fox", Phone="344-719-6596", Age=21, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("DF3A1644-007E-488A-D074-0902622D9EE0"), FirstName="Chester", LastName="Patrick", Phone="847-458-2877", Age=61, IsActive=false, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("22B8A759-68E3-ED7F-FEEC-B829D2F5AD1B"), FirstName="Chaney", LastName="Kent", Phone="911-959-5245", Age=49, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("9F608415-C523-F0E7-A0DD-D87BBEC0AE0D"), FirstName="Justin", LastName="Torres", Phone="300-987-6074", Age=66, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("0A4C749C-6B28-E098-8124-1DBEE1183CA5"), FirstName="Kai", LastName="Booth", Phone="798-685-6137", Age=52, IsActive=true, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("46205724-8D6D-56FE-0D7A-407A073CA172"), FirstName="Wanda", LastName="Anderson", Phone="427-440-1076", Age=47, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("7CA6ECDB-6146-533F-BC02-D9FF0413304A"), FirstName="Kylynn", LastName="Brown", Phone="654-154-5283", Age=36, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("D597A182-4436-97E3-341A-1B190AAF25C5"), FirstName="Plato", LastName="Spence", Phone="846-557-1191", Age=46, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("E0722C44-3DBF-7FF2-B0F0-F8F537321DD8"), FirstName="Leila", LastName="Sykes", Phone="826-157-5196", Age=46, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("B3F2E20B-D2D2-87E9-BFCE-ECA748199794"), FirstName="Colby", LastName="Huber", Phone="941-375-9723", Age=19, IsActive=true, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("CA2E2082-C5B5-21A0-A22C-17DAAF63D0A6"), FirstName="Indira", LastName="Fisher", Phone="327-513-6877", Age=70, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("6E221BD0-7461-04F2-D58D-A71B38DD8C70"), FirstName="Ivan", LastName="Cash", Phone="107-303-4072", Age=30, IsActive=true, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("31036E2A-441C-5606-D18B-E85A8521D320"), FirstName="Yael", LastName="Mendez", Phone="949-836-0532", Age=42, IsActive=false, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("EF1514F0-91FC-3CA6-838F-81D095D0CB4B"), FirstName="Anne", LastName="Anderson", Phone="144-402-9499", Age=36, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("19C6949D-22D6-8538-E8A4-2724E3A509C7"), FirstName="Rudyard", LastName="Langley", Phone="513-670-8986", Age=21, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("231869C4-6E64-CAA8-6C7D-A062E0931D85"), FirstName="Savannah", LastName="Garrison", Phone="456-824-9559", Age=55, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("A833A958-74E1-DE63-493C-E12BAD305868"), FirstName="Daniel", LastName="Rosa", Phone="306-833-0480", Age=52, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("AA43E7C5-0354-7E02-7C13-A733F1677AA7"), FirstName="Lesley", LastName="Norris", Phone="320-488-3379", Age=30, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("F15DAB96-464A-9927-8042-18906B99113C"), FirstName="Stuart", LastName="Delaney", Phone="862-901-5972", Age=51, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("32AF5D88-DDD5-AC78-28EC-FB17F91BF2EF"), FirstName="Paul", LastName="Lynch", Phone="848-897-0224", Age=68, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("BA98ABCC-E210-8561-97D6-8D6A71A75706"), FirstName="Maryam", LastName="Dickson", Phone="701-257-9455", Age=37, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("B6A92CE8-488A-0CD8-9BC5-1E38BB28AEC3"), FirstName="Isabella", LastName="Levy", Phone="960-186-2492", Age=24, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("1AE6CE39-9205-395D-C5B9-6754D43D29A9"), FirstName="Eugenia", LastName="Holland", Phone="959-675-5610", Age=59, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("2B9EA207-7552-364B-BD34-081BA20A156E"), FirstName="Lila", LastName="Mcleod", Phone="589-832-6273", Age=62, IsActive=true, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("03510981-AA7D-0D41-A14B-ADEBA62C164F"), FirstName="Iris", LastName="Sweeney", Phone="857-750-4826", Age=63, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("68FE95B4-74DB-73D2-8776-35F028B4E328"), FirstName="Kennan", LastName="Juarez", Phone="993-993-8703", Age=59, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("A57D9785-4465-6FDB-EE2A-F0E68D6D4CD4"), FirstName="Amena", LastName="Merritt", Phone="328-573-9321", Age=68, IsActive=false, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("FE028098-C6D8-FA61-EFC9-F0E49E9E3D24"), FirstName="Leila", LastName="Mendez", Phone="631-413-9715", Age=40, IsActive=false, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("FE0D8BEA-49B0-83AD-0F7F-7822D062BE76"), FirstName="Kimberley", LastName="Becker", Phone="692-363-4053", Age=25, IsActive=false, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("06C7C340-E7A7-D286-507C-901F4CEF9DED"), FirstName="Ima", LastName="Huber", Phone="990-997-0398", Age=64, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("93EC9ABF-984D-68EC-751C-B68C21E7FF96"), FirstName="Leilani", LastName="Workman", Phone="717-236-6913", Age=33, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("FCC7EFD3-2C45-C5CC-6E5C-2F49D7716F95"), FirstName="Kasimir", LastName="Ramirez", Phone="659-501-6054", Age=49, IsActive=true, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("67AB6392-4BE0-6AEA-BB54-0A7CB92A7D83"), FirstName="Reuben", LastName="Gonzales", Phone="168-816-1815", Age=38, IsActive=false, StatusId=3, Status="Platinum"},
                new Customer { Id=Guid.Parse("9035CE27-A4CB-1B8A-2C38-E961034CCC38"), FirstName="Hasad", LastName="Lee", Phone="214-594-7103", Age=49, IsActive=false, StatusId=3, Status="Platinum"},
                ...
                new Customer { Id=Guid.Parse("52E28680-539F-47D0-206E-D74EEF00B77F"), FirstName="Kenneth", LastName="Webster", Phone="900-872-5277", Age=31, IsActive=true, StatusId=3, Status="Platinum"},
